...
const Contact = () => {
  ...
  const onSubmit = (e) => {
    ...
    if (name.length === 0 || email.length === 0 || message.length === 0) {
      ...
      emailjs
        .send(
          "service_6a61yhq", // service id
          "template_2use7vb", // template id
          mailData,
          "fNMi2GcjXmErfUNwsu-2t" // public api
        )
        .then(
          (response) => {
            setError(false);
              ...
              <ul className="custom-list">
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">+212 6 40 29 47 62</span>
                  </h6>
                </li>
                <li>
                  <h6 className="font-weight-600">
                ...
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">Casablanca, Morocco</span>
                  </h6>
                </li>
              </ul>
                ...
                <ul className="list-inline social social-intro text-center p-none">
                  <li className="facebook">
                    <a
                      target="_balank"
                      title="Facebook"
                      href="https://web.facebook.com/profile.php?id=100006634848898"
                    >
                  ...
                  <li className="twitter">
                    <a
                      target="_balank"
                      title="Twitter"
                      href="https://twitter.com/AkrimSalah"
                    >
                  ...
                  <li className="github">
                    <a
                      target="_balank"
                      title="GitHub"
                      href="https://github.com/salahakrim"
                    >
                  ...
                  <li className="linkedin">
                    <a
                      target="_balank"
                      title="Linkedin"
                      href="https://www.linkedin.com/in/salaheddine-akrim/"
                    >
